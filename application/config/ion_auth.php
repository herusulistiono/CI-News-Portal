 ...
 */
$config['site_title']                 = "kerjakerja.id";       // Site Title, example.com
$config['admin_email']                = "noreply@kerjakerja.id"; // Admin Email, admin@example.com
$config['default_group']              = 'contributor';           // Default group, use name
...
$config['user_expire']                = 6300;               // How long to remember the user (seconds). Set to zero for no expiration
