      ...
      <div class="card-header bg-light"><?php echo $title; ?></div>
        <div class="card-body">
          ...
          <div id="info"></div>
            ...
            <?php echo form_hidden('txtCategory',$category_id); ?>
            ...
            <div class="form-group">
              ...
              <?php echo anchor('dashboard/fgd', 'Cancel',array('class'=>'btn btn-warning')); ?>
            </div>
          <?php echo form_close();; ?>
        </div>
    </div>
...
<script type="text/javascript">
  ...
  function update() {
    ...
    $.ajax({
      url: "<?php echo site_url('dashboard/fgd/update/') ?>",
      type: 'POST',
      dataType: 'json',
      data: data,
      ...
      success:function (data) {
        ...
        if (!data.success) {
          ...
          alert(data.message);
          window.location.href='<?php echo site_url('dashboard/fgd') ?>';
        }
      }
    })
  }
