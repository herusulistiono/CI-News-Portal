    ...
    <div class="single-post nobottommargin">
      <div class="entry clearfix">
        ...
        <div class="entry-image">
          <a class="" href="<?php echo base_url('images/news/grafis/'.$news_picture);?>" data-lightbox="image">
            <img class="image_fade img-responsive" src="<?php echo base_url('images/news/grafis/'.$news_picture);?>"/>
          </a>
        </div>
          ...
          <span>Share this Post:</span>
            <div>
              <?php 
                ...
                $whatsappURL = 'whatsapp://send?text='.$news_title. ' ' . base_url('infografis/read/'.$news_seo);
