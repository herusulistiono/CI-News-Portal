  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header bg-light">
        <?php echo $title; ?>
        <div class="text-right"><?php echo anchor('dashboard/HoaxorNot/create', 'Create',array('class'=>'btn btn-primary btn-rounded')); ?></div></div>
        <div class="card-body">
...
<script type="text/javascript">
  $('#news_data').DataTable({
    "processing": true,
    "ajax": {
    "url": "<?php echo site_url('dashboard/HoaxorNot/read_data/') ?>",
    "type": "POST"
    },
