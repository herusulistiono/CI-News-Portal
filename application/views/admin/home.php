    ...
    <div class="card p-4">
      <div class="card-body d-flex justify-content-between align-items-center">
        <div>
          ...
          <span class="font-weight-light">Total Users Active</span>
        </div>
  ...
  <div class="col-md-3">
    <div class="card p-4">
      <div class="card-body d-flex justify-content-between align-items-center">
        <div>
          <span class="h4 d-block font-weight-normal mb-2"></span>
          <span class="font-weight-light">Banned Users</span>
        </div>
        <div class="h2 text-muted">
  ...
  <div class="col-md-3">
    <div class="card p-4">
      <div class="card-body d-flex justify-content-between align-items-center">
        <div>
          <span class="h4 d-block font-weight-normal mb-2"></span>
          <span class="font-weight-light">Total Info Grafis</span>
        </div>
        <div class="h2 text-muted">
  ...
  <div class="col-md-3">
    <div class="card p-4">
      <div class="card-body d-flex justify-content-between align-items-center">
        <div>
          <span class="h4 d-block font-weight-normal mb-2"></span>
          <span class="font-weight-light">Total News</span>
        </div>
        <div class="h2 text-muted">
   ...
   <div class="col-md-12">
     <div class="card">
       ...
       <div class="card-body p-0">
         <div class="p-4"><canvas id="line-chart" width="100%" height="20"></canvas></div>
