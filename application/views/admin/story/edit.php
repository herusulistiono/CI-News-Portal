  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header bg-light"><?php echo $title; ?></div>
        <div class="card-body">
          <?php echo form_open('dashboard/story/update_story/', array('id'=>'form')); ?>
          <div id="info"></div>
            ...
            <div class="form-group">
              <img src="<?php echo base_url('images/news/story/'.$news_picture);?>" class="img-thumbnail" id="preview"/>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
  ...
  function update() {
    ...
    $.ajax({
      url: "<?php echo site_url('dashboard/story/update_story/') ?>",
      type: 'POST',
      dataType: 'json',
      data: data,
