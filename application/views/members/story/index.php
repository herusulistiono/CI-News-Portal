<div class="container clearfix">
  ...
  <div id="posts" class="post-grid grid-container clearfix" data-layout="fitRows">
    <?php foreach ($story as $show):?>
    <div class="entry clearfix">
      <div class="entry-image">
        <a href="<?php echo base_url('images/news/story/'.$show->news_picture);?>" data-lightbox="image">
          <img class="image_fade" src="<?php echo base_url('images/news/story/'.$show->news_picture);?>" alt=""/>
        </a>
      </div>
      <div class="entry-title">
        <h2>
          ...
          <?php 
            ...
            $thelength = 32;
            echo anchor('story/read/'.$show->news_seo,substr($link_title, 0, $thelength));
