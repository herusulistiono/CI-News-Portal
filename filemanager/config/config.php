...
$base_url = 'http://127.0.0.1';  // base url (only domain) of site (without final /). https://kerjakerja.web.id If you prefer relative urls leave empty
$upload_dir = '/images/news/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../images/news/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../images/news/'; // relative path from filemanager folder to thumbs folder (with final /)
//../plugins/js/wsyisg/cdn/tinymce/tinymce.min.js
